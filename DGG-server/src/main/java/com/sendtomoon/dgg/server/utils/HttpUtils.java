...
public class HttpUtils {
	...
	public static JSONObject putInvokeHttp(String url, Map<String, String> params, String postData,
	...
	public static JSONObject postInvokeHttp(String url, Map<String, String> params, String postData,
			Map<String, String> headers) throws IOException {
		// 创建默认的httpClient实例.
		CloseableHttpClient httpclient = HttpClients.createDefault();
		// 创建httpget
